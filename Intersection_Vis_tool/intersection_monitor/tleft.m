function [u2,u3,u4,u5,u6,u7,u8] = tleft(u1)
%u1 = [4,1,0,0...];
load('Cross')
...
u3 = Cross.(R3).lane1.Position;
u4 = Cross.(R3).(['lane',num2str(num)]).Position;
u5 = Cross.(['road',num2str(u1(1))]).lane_1.Position;
u6 = Cross.(['road',num2str(u1(1))]).(['lane_',num2str(num)]).Position;
