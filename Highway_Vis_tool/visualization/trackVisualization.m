...
handles.selectid = inputArguments.selectid;
handles.monitor_flag = inputArguments.monitor_flag;
handles.monitor_simout = inputArguments.monitor_simout;
...
set(handles.frameSlider,'Min', handles.minimumFrame);
set(handles.frameSlider,'Max', handles.maximumFrame);
set(handles.frameSlider,'SliderStep', [1/(handles.maximumFrame-handles.minimumFrame) 1]);
...
if handles.backgroundImagePath == ""
    ...
    imagesc([0 384], [1 203], backgroundImage);
